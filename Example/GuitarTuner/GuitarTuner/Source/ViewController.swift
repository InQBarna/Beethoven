...
extension ViewController: PitchEngineDelegate {
    func pitchEngine(_: PitchEngine, didReceivePitch pitch: Pitch) {
    ...
    func pitchEngine(_: PitchEngine, didReceiveError error: Error) {
        print(error)
    }

    public func pitchEngineWentBelowLevelThreshold(_: PitchEngine) {
